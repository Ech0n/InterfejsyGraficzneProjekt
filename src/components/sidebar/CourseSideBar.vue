              ...
              <li>
                ...
                <ul class="list-none p-0 m-0">
                  ...
                  <li v-for="(chapter, chapterIndex) in courseChapters.chapters" :key="chapter.key" class="my-2">
                    <a v-if="owned" v-ripple @click="emit('completeChapter', chapter); closeCallback();" class="flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple text-decoration-none">
...
<!--                      <i class="pi pi-caret-right mx-1"></i>-->
                      <svg width="31" height="31" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <text v-if="owned" x="50%" y="50%" dominant-baseline="middle" text-anchor="middle">{{ parseInt(chapterIndex) + 1 }}</text>
                        <g v-else>
                    ...
                    <a v-else v-ripple  class="flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple text-decoration-none">
                      <!--                      <span>{{ chapterIndex + 1}}</span>-->
                      <!--                      <i class="pi pi-caret-right mx-1"></i>-->
                      <svg width="31" height="31" xmlns="http://www.w3.org/2000/svg">
                        <rect x="12" y="-10" width="20" height="20" transform="rotate(45)" fill="violet" />
...
const props = defineProps(["owned", "chapter", "courseItem", "courseChapters", "mainPage"]);
